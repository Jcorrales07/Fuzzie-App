...
const Navbar = async (props: Props) => {
    return (
        <header className='fixed right-0 left-0 top-0 py-4 px-4 bg-black/40 backdrop-blur-lg z-[100] flex items-center
            ...
            <nav className={'absolute left-[50%] top-[50%] transform translate-x-[-50%] translate-y-[-50%] hidden ' +
                'md:block'}>
            ...
            <aside className='flex items-center gap-4'>
                <Link href='/dashboard'
                    ...
                    rounded-full p-[2px] focus:ring-offset-2 focus:ring-offset-slate-50'
                >
