...
import {HeroParallax} from "@/components/global/connect-parrallax";
...
export default function Home() {
    return (
        ...
        relative flex flex-col items-center antialiased">
                    ...
                    <ContainerScroll
                        titleComponent={
                            <div className={'flex items-center justify-center flex-col'}>
                                <Button size={'lg'} className={"py-8 mb-8 md:mb-0 text-2xl sm:w-fit border-t-2 " +
                                    "rounded-full border-[#4D4D4D] bg-[#1f1f1f] hover:bg-white group transition-all flex " +
            ...
            <InfiniteMovingCards className={'m-auto md:mt-[18rem] mt-[-100px]'}
                                 items={clients}
                                 direction={'right'}
                                 speed='slow'
            />
